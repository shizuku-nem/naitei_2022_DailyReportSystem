...
<meta charset="utf-8">
    ...
    <link href="<c:url value="/assets/users/lib/owlcarousel/assets/owl.carousel.min.css"/>" rel="stylesheet">
    <link href="<c:url value="/assets/users/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css"/>" rel="stylesheet">
<head/>

<div class="container-fluid position-relative d-flex p-0">
	<%@ include file="/WEB-INF/views/layouts/users/spinner.jsp" %>
	<%@ include file="/WEB-INF/views/layouts/users/sidebar.jsp"%>
	<div class="content">
		<%@ include file="/WEB-INF/views/layouts/users/navbar.jsp"%>
		<decorator:body />
	</div>
</div>
